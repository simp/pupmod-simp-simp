...
mcollective::middleware_ssl_cert_path : '/etc/mcollective/ssl/middleware_cert.pub'
  ...
  context 'default parameters' do
    ...
    it 'should configure mco server, client, and middleware with no errors' do
...
plugin.ssl_client_public = /home/mco_user/mco_user_cert_rsa.pem
...
EOF"
        ...
        on node, "openssl rsa -in /home/mco_user/mco_user_key.pem -pubout > /home/mco_user/mco_user_cert_rsa.pem"
        on node, "cp /home/mco_user/mco_user_cert_rsa.pem /etc/mcollective/ssl/clients/"
        ...
        Dir.mktmpdir { |dir|
          scp_from(node, '/home/mco_user/mco_user_cert_rsa.pem', dir)
          scp_to(server, "#{dir}/mco_user_cert_rsa.pem", "/etc/mcollective/ssl/clients/")
        }
      end
    end
